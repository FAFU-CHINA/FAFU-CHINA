...
xlabel('X'),ylabel('Y')
title({['Degree of gas diffusion'];['Jacobi Method'];['Iterations taken : ',num2str(n_Jacobi)]})
Psi_GS = zeros(N,M);
...
xlabel('X'),ylabel('Y')
title({['Degree of gas diffusion'];['Gauss-Seidel Method'];['Iterations taken : ',num2str(n_GS)]})
...
xlabel('X'),ylabel('Y')
title({['Degree of gas diffusion'];['PSOR Method'];['Iterations taken : ',num2str(n_PSOR)]})
